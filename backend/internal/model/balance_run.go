...
type BalanceRun struct {
	...
	BalanceStatus       constants.BalanceStatus  `json:"balance_status" gorm:"type:varchar(24);not null;check:balance_status IN ('queued','calculating','pending_review','accepted','rejected','invalidated','recalculate_required','superseded')"`
	...
	RecalculationReason datatypes.JSON           `json:"recalculation_reason_json" gorm:"column:recalculation_reason_json;type:jsonb"`
	SupersedesID        *uint                    `json:"supersedes_id" gorm:"uniqueIndex"`
